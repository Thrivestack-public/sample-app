...
export default function EditDetails({ close, name, email, updateName }) {
    ...
    return (
        <div
            ...
            <div
                ...
                className="w-[520px] flex flex-col bg-white rounded-2xl py-2 z-[20001] pointer-events-auto"
            >
                <div className="flex items-center justify-between rounded-t-lg border-b border-[#E2E8F0]">
                    <div className="flex items-center justify-between py-3 px-7 w-full">
                        <h2 className="text-2xl font-sansBig">Edit details</h2>
                ...
                <div className="flex flex-col px-7">
                    <div className="flex flex-col mt-7">
                        <span className="text-[#334155] pb-1">Member name</span>
                        <input
                            onChange={(e) => setNewName(e.target.value)}
                            value={newName}
                            className="p-[16px] rounded-md bg-white border border-[#E2E8F0] outline-none h-[56px] text-[#0F172A]"
                        />
                    </div>

                    <div className="flex flex-col mt-5 mb-5">
                        <span className="text-[#94A3B8] pb-1">Email ID</span>
                        <input
                            disabled
                            value={email}
                            className="p-[16px] rounded-md bg-white border border-[#E2E8F0] outline-none h-[56px] text-[#94A3B8] font-sansLight"
                        />
                    </div>

                    <div className="flex justify-end pb-3">
                        <div className="flex items-center gap-3">
                            <Button text="Cancel" cancel={true} onClick={() => close()} />
                            <Button
                                text="Save"
                                onClick={() => {
                                    updateName(newName);
